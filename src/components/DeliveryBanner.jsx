...
const DB = {
    ...
    changeBtn: { background: "none", border: "1px solid #1b4332", color: "#1b4332", borderRadius: 6, padding: "3px 11px", fontSize: 12, cursor: "pointer", fontFamily: "sans-serif", fontWeight: 600 },
    ...
    zoneBtnOn: { background: "#1b4332", border: "2px solid #1b4332", color: "#fff" },
};
                    ...
                    <div style={DB.zoneGrid}>
                        {BLR_ZONES.map(z => (
                            ...
                            >
                                ...
                                <span style={{ fontSize: 11, color: zone === z.id ? "#fff" : "#1b4332", marginTop: 2 }}>
                                    ⚡ ~{z.eta} min
                                </span>
                            </button>
                        ))}
